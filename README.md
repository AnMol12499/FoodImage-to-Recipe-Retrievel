...
```shell
git clone --recursive https://github.com/AnMol12499/FoodImage-to-Recipe-Retrievel.git
```
...
## [Project Report Pdf](https://github.com/AnMol12499/FoodImage-to-Recipe-Retrievel/blob/main/Final_Report_CS771%20(2).pdf)
